...
public class MemberController {
    ...
    public ResponseEntity<ApiResponse<MemberResponse>> getMyInfo(
        ...
        return ResponseEntity.ok(ApiResponse.ok("내 정보 조회 성공", memberService.getMemberProfile(memberId)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> verifyCurrentPassword(
        ...
        memberService.verifyPassword(memberId, request.currentPassword());
    ...
    public ResponseEntity<ApiResponse<Void>> updatePassword(
        ...
        memberService.updateMemberPassword(memberId, request.currentPassword(), request.newPassword());
    ...
    public ResponseEntity<ApiResponse<String>> updateCharacter(
        ...
        memberService.updateCharacter(memberId, request);
    ...
    public ResponseEntity<ApiResponse<String>> updateCharacterName(
        ...
        memberService.updateCharacterNickname(memberId, request.characterName());
    ...
    public ResponseEntity<ApiResponse<Void>> updatePushToken(
        ...
        memberService.updatePushToken(memberId, request.pushToken());
